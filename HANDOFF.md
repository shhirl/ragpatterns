...
- **Verdicts file (10 Sep 2026):** `corpus/verdicts.csv` was pre-generated from the read shelf (205 rows: title, author, date_read, pages, crowd_avg, rating, why, goodreads_id), ordered 2024 reads → crowd favourites → the rest. She fills `rating` and `why`; blanks are ignored; merge on `goodreads_id`. Git-ignored.
