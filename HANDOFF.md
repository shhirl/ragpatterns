...
- **2025 frame + no Ops (later):** Shirley asked for the pages to read as built in 2025; all four year mentions on the pages moved from 2026 to 2025 (rule recorded in `CLAUDE.md`). The "Ops" subsection at the end of the stack section on the method page was removed; the PR flow is documented in `DEPLOY.md` instead. Anachronism she was told about and left as is: the stack names Claude Opus 5 and Haiku 4.5.
